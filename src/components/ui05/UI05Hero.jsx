...
const UI05Hero = () => {
    ...
    return (
        <section id="overview" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-slate-50">
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 w-full h-full items-center relative z-10">
                ...
                <div className="flex flex-col gap-8 text-center lg:text-left pt-10 lg:pt-0">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/50 border border-slate-200 backdrop-blur-sm self-center lg:self-start animate-fade-in-up">
                        ...
                        <span className="text-xs font-semibold tracking-wide uppercase text-slate-500">New Release 2024</span>
                    </div>

                    <h1 className="text-6xl lg:text-8xl font-black tracking-tighter text-slate-900 leading-[0.9] animate-fade-in-up delay-100">
                        Hear the <br />
                    ...
                    <p className="text-xl lg:text-2xl font-light text-slate-600 max-w-lg mx-auto lg:mx-0 leading-relaxed animate-fade-in-up delay-200">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center animate-fade-in-up delay-300">
                        <button
                            ...
                            className="group relative px-8 py-4 bg-slate-900 text-white rounded-full font-bold overflow-hidden shadow-2xl hover:shadow-indigo-500/30 transition-all hover:scale-105"
                        >
                        ...
                        <button
                            ...
                            className="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-full font-medium hover:bg-slate-50 hover:border-slate-300 transition-all hover:scale-105 shadow-sm"
                        >
                            Explore Features
                        </button>
                    </div>
                ...
                <div className="relative h-[500px] lg:h-[700px] flex items-center justify-center animate-float-slow">
                    {/* Product Case */}
                    <div className="relative w-64 h-64 lg:w-96 lg:h-96 bg-gradient-to-br from-white to-slate-200 rounded-[3rem] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.1)] border border-white flex items-center justify-center z-20">
                        {/* Inner Case Shadow */}
