...
const StatCounter = ({ label, value, suffix = "+" }) => {
    ...
    return (
        <div ref={elementRef} className="text-center group cursor-default">
            <div className="text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-slate-600 mb-2 group-hover:scale-110 transition-transform duration-300">
                {count}{suffix}
            </div>
            <div className="text-sm font-bold uppercase tracking-widest text-indigo-500 group-hover:text-indigo-600 transition-colors">
                {label}
            </div>
