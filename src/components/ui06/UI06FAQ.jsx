            ...
            <div className="max-w-3xl mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <div className="relative max-w-md mx-auto">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-3 rounded-full border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-100 outline-none transition-all"
                        />
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    {filtered.length === 0 ? (
                        ...
                        <div
                            key={idx}
                            className="bg-white rounded-2xl border border-slate-200 overflow-hidden cursor-help hover:border-orange-300 transition-colors"
