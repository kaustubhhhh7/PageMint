        ...
        <section id="venue" className="py-24 bg-slate-50 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center mt-12">
                <div className="space-y-8">
                    <div>
                        <span className="text-indigo-600 font-bold tracking-widest uppercase text-sm mb-2 block">The Location</span>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 text-sm text-indigo-900 font-medium">
                ...
                {/* Map Placeholder */}
                <div className="relative h-[500px] w-full bg-slate-200 rounded-3xl overflow-hidden shadow-2xl group">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">
                        <button className="w-full font-bold text-indigo-600 uppercase text-xs tracking-widest text-center">Open in Google Maps</button>
                    </div>
                </div>
            </div>
        </section>
