        ...
        <section id="venue" className="py-24 bg-slate-50 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center mt-12">
                <div className="space-y-8">
                    <div>
                        <span className="text-orange-600 font-bold tracking-widest uppercase text-sm mb-2 block">The Location</span>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="bg-orange-50 border border-orange-100 rounded-xl p-4 text-sm text-orange-900 font-medium">
                ...
                {/* Map Placeholder */}
                <div className="relative h-[500px] w-full bg-slate-200 rounded-3xl overflow-hidden shadow-2xl group border-4 border-orange-200">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-xl animate-bounce border-2 border-orange-500">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-4 group-hover:translate-y-0">
                        <button className="w-full font-bold text-orange-600 uppercase text-xs tracking-widest text-center">Open in Google Maps</button>
                    </div>
                </div>
            </div>
        </section>
